...
typedef void(*render_callback)(uint16_t *frame_buffer);
typedef void(*audio_callback)(short *samples);
...
public:
    ...
    void set_render_callback(render_callback callback);
    void set_audio_callback(audio_callback callback);
};
